...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    $plate_id = $_POST['car_plateID'];

    
    $query0 = "SELECT c.car_id, c.car_model, c.year, c.car_category, c.car_colour, c.plate_id, c.price_per_day, c.car_status, c.car_office_id
    FROM car c JOIN reservation r ON c.car_id = r.car_id
    WHERE c.plate_id = '$plate_id' AND r.res_date BETWEEN '$start_date' AND '$end_date' ";
    ...
    if (mysqli_num_rows($result0) > 0) {
        ...
        <div class="table-responsive" style="padding-left: 100px; padding-right: 100px;">
            <table class="table table-striped">
                ...
                <?php
                $query1 = "SELECT r.res_id, r.res_date, r.rent_start_date, r.rent_end_date,r.payment, r.cust_ssn , r.car_id, r.office_id 
                FROM reservation r JOIN car  c ON r.car_id = c.car_id
                WHERE c.plate_id = '$plate_id' AND r.res_date BETWEEN '$start_date' AND '$end_date'";
