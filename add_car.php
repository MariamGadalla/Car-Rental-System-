...
<body>
    ...
    <div class="container" style="margin-top: 65px;">
        <div class="col-md-7" style="float: none; margin: 0 auto;">
            <div class="form-area">
                <form role="form" action="insert_car.php" enctype="multipart/form-data" method="POST">
                    <br style="clear: both">
                    <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Please Provide The Car
                        Details</h3>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="car_category" name="car_category"
                            placeholder="Car Category" required>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="price_per_day" name="price_per_day"
                            placeholder="Price per day (EGP)" required>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="car_colour" name="car_colour"
                            placeholder="Car Colour" required>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="car_office_id" name="car_office_id"
                            placeholder="Car Office ID" required>
                    </div>
