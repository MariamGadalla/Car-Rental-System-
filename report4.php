...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    $query0 = "SELECT c.car_id, c.car_model, c.plate_id FROM car  c JOIN reservation  r ON c.car_id = r.car_id  JOIN customer cust ON r.cust_ssn=cust.ssn
    WHERE cust.ssn = '$customer_ssn'";
    ...
    if (mysqli_num_rows($result0) > 0) {
        ...
        <div class="table-responsive" style="padding-left: 100px; padding-right: 100px;">
            <table class="table table-striped">
                ...
                reservation WHERE cust_ssn = '$customer_ssn' ";
    ...
    <div class="table-responsive" style="padding-left: 100px; padding-right: 100px;">
        <table class="table table-striped">
            ...
            $query2 = "SELECT * FROM customer WHERE ssn = '$customer_ssn'";
